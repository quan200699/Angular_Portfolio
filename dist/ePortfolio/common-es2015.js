...
let CoachService = class CoachService {
    ...
    getAllEvaluationByCoach(id) {
        return this.http.get(API_URL + `/coaches/${id}/evaluations`);
    }
    getCoach(id) {
...
let TemplateService = class TemplateService {
    ...
    getAllEvaluationsByTemplate(id) {
        return this.http.get(API_URL + `/templates/${id}/evaluations`);
    }
