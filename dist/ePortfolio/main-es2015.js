...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<nav class=\"main-header navbar navbar-expand navbar-primary navbar-dark\">\r\n  <a class=\"navbar-brand\" routerLink=\"\">ePortfolio</a>\r\n  <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">\r\n    <ul class=\"navbar-nav mr-auto\">\r\n      <li class=\"nav-item active mr-sm-3\">\r\n        <a class=\"nav-link\" routerLink=\"\">\r\n          <i class=\"fa fa-home fa-lg\"></i>\r\n          Trang chủ<span class=\"sr-only\">(current)</span></a>\r\n      </li>\r\n      <form class=\"form-inline ml-3\">\r\n        <div class=\"input-group input-group-sm\">\r\n          <input class=\"form-control form-control-navbar\" type=\"search\" placeholder=\"Search\" aria-label=\"Search\">\r\n          <div class=\"input-group-append\">\r\n            <button class=\"btn btn-navbar\" type=\"submit\">\r\n              <i class=\"fa fa-search\"></i>\r\n            </button>\r\n          </div>\r\n        </div>\r\n      </form>\r\n    </ul>\r\n    <div class=\"my-2 my-lg-0\">\r\n      <ul class=\"navbar-nav mr-auto\" *ngIf=\"!currentUser\">\r\n        <li class=\"nav-item\">\r\n          <a class=\"nav-link\" routerLink=\"login\"><i class=\"fa fa-sign-in fa-lg\"></i> Đăng nhập</a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a class=\"nav-link\" routerLink=\"register\"><i class=\"fa fa-user-plus fa-lg\"></i> Đăng ký</a>\r\n        </li>\r\n      </ul>\r\n      <ul class=\"navbar-nav mr-auto\" *ngIf=\"currentUser\">\r\n        <li class=\"nav-item\">\r\n          <a class=\"nav-link\" routerLink=\"#\" (click)=\"logout()\"><i class=\"fa fa-sign-out\"></i> Đăng xuất</a>\r\n        </li>\r\n      </ul>\r\n    </div>\r\n  </div>\r\n</nav>\r\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<aside class=\"main-sidebar sidebar-dark-primary elevation-4\">\r\n  <!-- Brand Logo -->\r\n  <a routerLink=\"\" class=\"brand-link\">\r\n        <img src=\"../../../assets/static/img/logo-ePortfolio.png\"\r\n             alt=\"ePortfolio Logo\"\r\n             class=\"brand-image img-circle elevation-3\"\r\n             style=\"opacity: .8\">\r\n    <span class=\"brand-text font-weight-light\">ePortfolio</span>\r\n  </a>\r\n\r\n  <!-- Sidebar -->\r\n  <div class=\"sidebar\">\r\n    <!-- Sidebar user (optional) -->\r\n    <div class=\"user-panel mt-3 pb-3 mb-3 d-flex\">\r\n            <div class=\"image\">\r\n              <i class=\"fa fa-user fa-2x\" style=\"color: white\"></i>\r\n            </div>\r\n      <div class=\"info\" *ngIf=\"currentUser && hasRoleAdmin\">\r\n        <a [routerLink]=\"'/admin/coach-management/info/'+currentUser.id\" class=\"d-block\">{{currentUser.email}}</a>\r\n      </div>\r\n      <div class=\"info\" *ngIf=\"currentUser && !hasRoleAdmin\">\r\n        <a [routerLink]=\"'/admin/coach-management/info/'+currentUser.id\" class=\"d-block\">{{currentUser.name}}</a>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Sidebar Menu -->\r\n    <nav class=\"mt-2\">\r\n      <ul class=\"nav nav-pills nav-sidebar flex-column\" data-widget=\"treeview\" role=\"menu\" data-accordion=\"false\">\r\n        <!-- Add icons to the links using the .nav-icon class\r\n             <br /> with font-awesome or any other icon font library -->\r\n        <li class=\"nav-item\" *ngIf=\"hasRoleAdmin\">\r\n          <a routerLink=\"/admin/coach-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Giảng viên\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/admin/classes-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Lớp học\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\" *ngIf=\"hasRoleAdmin\">\r\n          <a routerLink=\"/admin/student-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Học viên\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/admin/program-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Chương trình học\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/evaluation\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Bản đánh giá\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/evaluation-detail\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Đánh giá\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/admin/evaluation-form\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Bản mẫu đánh giá\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\">\r\n          <a routerLink=\"/admin/template-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Bản mẫu\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\" *ngIf=\"hasRoleAdmin\">\r\n          <a routerLink=\"/admin/outcome-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Outcome\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\" *ngIf=\"hasRoleAdmin\">\r\n          <a routerLink=\"/admin/category-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Danh mục\r\n            </p>\r\n          </a>\r\n        </li>\r\n        <li class=\"nav-item\" *ngIf=\"hasRoleAdmin\">\r\n          <a routerLink=\"/admin/skill-management\" class=\"nav-link\">\r\n            <i class=\"nav-icon fa fa-list\"></i>\r\n            <p>\r\n              Kỹ năng\r\n            </p>\r\n          </a>\r\n        </li>\r\n      </ul>\r\n    </nav>\r\n    <!-- /.sidebar-menu -->\r\n  </div>\r\n  <!-- /.sidebar -->\r\n</aside>\r\n");
...
/* harmony import */ var _layout_layout_with_shared_layout_with_shared_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./layout/layout-with-shared/layout-with-shared.component */ "./src/app/layout/layout-with-shared/layout-with-shared.component.ts");
...
const routes = [
    {
        path: '',
        component: _layout_layout_with_shared_layout_with_shared_component__WEBPACK_IMPORTED_MODULE_4__["LayoutWithSharedComponent"],
        children: [
            {
                path: 'admin',
                loadChildren: () => Promise.all(/*! import() | admin-admin-module */[__webpack_require__.e("common"), __webpack_require__.e("admin-admin-module")]).then(__webpack_require__.bind(null, /*! ./admin/admin.module */ "./src/app/admin/admin.module.ts")).then(module => module.AdminModule)
            },
            {
                path: 'coach',
            ...
            {
                path: 'evaluation',
                loadChildren: () => Promise.all(/*! import() | evaluation-evaluation-module */[__webpack_require__.e("common"), __webpack_require__.e("evaluation-evaluation-module")]).then(__webpack_require__.bind(null, /*! ./evaluation/evaluation.module */ "./src/app/evaluation/evaluation.module.ts")).then(module => module.EvaluationModule)
            },
            {
                path: 'evaluation-detail',
                loadChildren: () => Promise.all(/*! import() | evaluation-detail-evaluation-detail-module */[__webpack_require__.e("common"), __webpack_require__.e("evaluation-detail-evaluation-detail-module")]).then(__webpack_require__.bind(null, /*! ./evaluation-detail/evaluation-detail.module */ "./src/app/evaluation-detail/evaluation-detail.module.ts")).then(module => module.EvaluationDetailModule)
            }
        ]
    },
    {
...
/* harmony import */ var _layout_layout_with_shared_layout_with_shared_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./layout/layout-with-shared/layout-with-shared.component */ "./src/app/layout/layout-with-shared/layout-with-shared.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _layout_layout_with_shared_layout_with_shared_component__WEBPACK_IMPORTED_MODULE_12__["LayoutWithSharedComponent"],
        ],
        imports: [
        ...
        providers: [
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _helper_jwt_interceptor__WEBPACK_IMPORTED_MODULE_8__["JwtInterceptor"], multi: true },
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_5__["HTTP_INTERCEPTORS"], useClass: _helper_error_interceptor__WEBPACK_IMPORTED_MODULE_9__["ErrorInterceptor"], multi: true }
        ],
...
module.exports = __webpack_require__(/*! E:\Angular\ePortfolio\src\main.ts */"./src/main.ts");
